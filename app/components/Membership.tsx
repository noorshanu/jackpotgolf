...
import { FaLightbulb, FaRegMoon, FaLocationArrow } from "react-icons/fa";
...
export default function Membership() {
  return (
    <section className="relative flex w-full flex-col items-center justify-start overflow-hidden py-16 md:py-24">
      ...
      {/* Infinite Loop Marquee - Full Width */}
      <div
      ...
      >
        <div
          className="flex w-max gap-4 md:gap-6 py-4 hover:[animation-play-state:paused]"
          style={{ animation: "marquee-left 50s linear infinite" }}
        >
          {[...FEATURES, ...FEATURES].map((feature, idx) => (
            <div
              key={idx}
              className="group relative w-[290px] shrink-0 md:w-[340px] rounded-2xl p-[1.5px] bg-gradient-to-br from-[#eab308]/60 via-[#3a4654]/40 to-[#eab308]/30 transition-all duration-300 hover:from-[#eab308] hover:via-[#eab308]/30 hover:to-[#eab308] hover:scale-[1.02] hover:shadow-[0_0_40px_rgba(234,179,8,0.25)]"
            >
